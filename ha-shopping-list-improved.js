...
const TRANSLATIONS = {
    ...
    fr: {
        "card.description"                              : "Liste de courses améliorée avec tri alphabétique, modèles d'ajout, quantité au début ou à la fin, position des chips personnalisable et boutons plus/moins pour ajuster la quantité.",
        ...
        "ui.common.sync"                                : "Synchronisation...",
        "ui.common.sync_finished"                       : "Synchronisation terminée !",
        "ui.common.sync_error"                          : "Erreur lors de la synchronisation :",
        "ui.common.sync_without_category"               : "Sans catégorie",
        "ui.common.sync_offline_list"                   : "Liste de courses hors ligne",
        "ui.common.sync_created"                        : "créé le",
        "ui.common.export"                              : "Export HTML",
        "ui.common.export_pdf"                          : "Export PDF",
        "ui.common.close"                               : "Fermer",
        "ui.common.dynamic_category"                    : "Nouvelle catégorie (dynamique)",
        "ui.common.loading_list"                        : "Chargement de la liste...",
        "ui.message.quantity_increased"                 : "Quantité augmentée",
        "ui.message.quantity_decreased"                 : "Quantité diminuée",
        ...
        "ui.admin.options.browser_chips"                : "Chips du navigateur",
        "ui.admin.options.browser_chips_copy"           : "Copier",
        "ui.admin.options.browser_chips_delete"         : "Supprimer les Chips du navigateur",
        "ui.admin.options.browser_chips_delete_con"     : "Êtes-vous sûr de vouloir supprimer tous les Chips du navigateur ?",
        "ui.admin.options.dynamic_categories"           : "Catégories dynamiques",
        "ui.admin.options.dynamic_categories_copy"      : "Copier",
        "ui.admin.options.dynamic_categories_include"   : "Inclure les articles",
        "ui.admin.options.manual_assigned"              : "Articles assignés manuellement",
        "ui.admin.options.manual_assigned_copy"         : "Copier",
        "ui.admin.options.manual_assigned_include"      : "Inclure les articles déjà configurés",
        "ui.todo.general"                               : "Général",
        "ui.todo.hours"                                 : "Heures",
        "ui.todo.days"                                  : "Jours",
        "ui.todo.months"                                : "Mois",
        "ui.todo.due_every"                             : "Échéance tous les :",
        "ui.todo.next_due"                              : "Prochaine échéance :",
        "ui.todo.remove_due"                            : "Supprimer la date d'échéance",
        "ui.todo.next_due"                              : "Définir la prochaine échéance",
        "ui.todo.next_due_now"                          : "Définir la prochaine échéance à partir de maintenant",
        "ui.todo.edit"                                  : "Modifier l'entrée",
        "ui.todo.delete"                                : "Supprimer l'entrée",
        ...
        "ui.todo.list.months"                           : "Mois",
        "ui.todo.list.day"                              : "Jour",
        "ui.todo.list.days"                             : "Jours",
        "ui.todo.list.hour"                             : "Heure",
        "ui.todo.list.hours"                            : "Heures",
        "ui.todo.list.minute"                           : "Minute",
        "ui.todo.list.minutes"                          : "Minutes",
        "ui.todo.set.completed.true"                    : "Marquer comme terminé",
        "ui.todo.set.completed.false"                   : "Marquer comme non terminé",
        "ui.labels.alert_item_exists_todo"              : "L'article « {item} » existe déjà dans la liste de choses à faire.",

        "editor.placeholders.quantity"                  : "Quantité",
        "editor.placeholders.item"                      : "Article...",
        "editor.labels.show_message_button"             : "Afficher le bouton de message",
        "editor.labels.notify_entity"                   : "Entité de notification",
        "editor.labels.add_button"                      : "Ajouter",
        "editor.labels.clear_button"                    : "Effacer les terminés",
        "editor.labels.no_items"                        : "Aucun article",
        "editor.labels.confirm_remove"                  : "Retirer « {item} » de la liste ?",
        "editor.labels.complete_btn"                    : "Marquer comme fait",
        "editor.labels.plus_btn"                        : "Augmenter la quantité",
        "editor.labels.minus_btn"                       : "Diminuer la quantité ou supprimer",
        "editor.labels.confirm_remove"                  : "Supprimer l'article « {item} » ?",
        "editor.labels.confirm_clear_done"              : "Supprimer tous les articles terminés ?",
        ...
        "editor.labels.categories"                      : "Catégories",
        "editor.labels.show_cat_count"                  : "Afficher le nombre d'articles dans les catégories ?",
        "editor.labels.show_cat_next_due"               : "Afficher la prochaine échéance dans la catégorie ?",
        ...
        "editor.labels.show_title_exclamation_mark"     : "Point d'exclamation pour les articles à échéance (titre)",
        ...
        "editor.labels.show_category_chips"             : "Générer des chips à partir des articles de la catégorie",
        ...
        "editor.options.chips_position.auto"            : "Automatique Droite / Bas (selon la taille de l'écran)",
        "editor.options.chips_position.auto_panel"      : "Automatique Panneau / Bas (selon la taille de l'écran)",
        "editor.options.chips_position.bottom"          : "Toujours en bas",
        "editor.options.chips_position.right"           : "Toujours à droite",
        "editor.options.chips_position.full"            : "À droite, multi-colonnes (mode panneau uniquement)",
        "editor.options.chips_position.none"            : "Aucun chip (masquer les chips)",
        "editor.options.chip_click.single"              : "Clic simple",
        "editor.options.chip_click.dblclick"            : "Double-clic",
        "editor.options.chip_merge.combined"            : "Combiner les chips standards et du navigateur (par défaut)",
        "editor.options.chip_merge.standard_first"      : "Chips standards d'abord, puis chips du navigateur",
        "editor.options.chip_merge.browser_first"       : "Chips du navigateur d'abord, puis chips standards",
        "editor.options.chip_merge.global_only"         : "Uniquement les chips globaux (fichier texte)",
        "editor.options.chip_merge.global_combined"     : "Tous les chips combinés (globaux, standards, navigateur)",
        "editor.options.quantity.beginning"             : "Quantité au début, ex. « 10x Beurre »",
        "editor.options.quantity.end"                   : "Quantité à la fin, ex. « Beurre (10) »",
        "editor.options.acknowledged.show"              : "Afficher les articles terminés",
        "editor.options.acknowledged.hide"              : "Masquer les articles terminés",
        "editor.options.acknowledged.end"               : "Afficher les articles terminés à la fin de la catégorie",
        ...
        "editor.options.category_merge.global_only"                         : "[1] Uniquement globales (fichier texte)",
        "editor.options.category_merge.dynamic_only"                        : "[1] Uniquement dynamiques",
        "editor.options.category_merge.local_only_sorted"                   : "[1] Uniquement locales (triées)",
        "editor.options.category_merge.global_only_sorted"                  : "[1] Uniquement globales (triées)",
        "editor.options.category_merge.dynamic_only_sorted"                 : "[1] Uniquement dynamiques (triées)",
        "editor.options.category_merge.local_global"                        : "[2] Locales → Globales",
        "editor.options.category_merge.local_dynamic"                       : "[2] Locales → Dynamiques",
        "editor.options.category_merge.global_dynamic"                      : "[2] Globales → Dynamiques",
        "editor.options.category_merge.global_local"                        : "[2] Globales → Locales",
        "editor.options.category_merge.dynamic_local"                       : "[2] Dynamiques → Locales",
        "editor.options.category_merge.dynamic_global"                      : "[2] Dynamiques → Globales",
        "editor.options.category_merge.local_global_sorted"                 : "[2] Locales → Globales (triées)",
        "editor.options.category_merge.local_dynamic_sorted"                : "[2] Locales → Dynamiques (triées)",
        "editor.options.category_merge.global_dynamic_sorted"               : "[2] Globales → Dynamiques (triées)",
        "editor.options.category_merge.global_local_sorted"                 : "[2] Globales → Locales (triées)",
        "editor.options.category_merge.dynamic_local_sorted"                : "[2] Dynamiques → Locales (triées)",
        "editor.options.category_merge.dynamic_global_sorted"               : "[2] Dynamiques → Globales (triées)",
        "editor.options.category_merge.local_global_sorted_total"           : "[2] Locales + Globales (entièrement triées)",
        "editor.options.category_merge.local_dynamic_sorted_total"          : "[2] Locales + Dynamiques (entièrement triées)",
        "editor.options.category_merge.global_dynamic_sorted_total"         : "[2] Globales + Dynamiques (entièrement triées)",
        "editor.options.category_merge.global_local_sorted_total"           : "[2] Globales + Locales (entièrement triées)",
        "editor.options.category_merge.dynamic_local_sorted_total"          : "[2] Dynamiques + Locales (entièrement triées)",
        "editor.options.category_merge.dynamic_global_sorted_total"         : "[2] Dynamiques + Globales (entièrement triées)",
        "editor.options.category_merge.local_global_dynamic"                : "[3] Locales → Globales → Dynamiques",
        "editor.options.category_merge.local_dynamic_global"                : "[3] Locales → Dynamiques → Globales",
        "editor.options.category_merge.global_local_dynamic"                : "[3] Globales → Locales → Dynamiques",
        "editor.options.category_merge.global_dynamic_local"                : "[3] Globales → Dynamiques → Locales",
        "editor.options.category_merge.dynamic_local_global"                : "[3] Dynamiques → Locales → Globales",
        "editor.options.category_merge.dynamic_global_local"                : "[3] Dynamiques → Globales → Locales",
        "editor.options.category_merge.local_global_dynamic_sorted"         : "[3] Locales → Globales → Dynamiques (triées)",
        "editor.options.category_merge.local_dynamic_global_sorted"         : "[3] Locales → Dynamiques → Globales (triées)",
        "editor.options.category_merge.global_local_dynamic_sorted"         : "[3] Globales → Locales → Dynamiques (triées)",
        "editor.options.category_merge.global_dynamic_local_sorted"         : "[3] Globales → Dynamiques → Locales (triées)",
        "editor.options.category_merge.dynamic_local_global_sorted"         : "[3] Dynamiques → Locales → Globales (triées)",
        "editor.options.category_merge.dynamic_global_local_sorted"         : "[3] Dynamiques → Globales → Locales (triées)",
        "editor.options.category_merge.local_global_dynamic_sorted_total"   : "[3] Locales + Globales + Dynamiques (entièrement triées)",
        "editor.options.category_merge.local_dynamic_global_sorted_total"   : "[3] Locales + Dynamiques + Globales (entièrement triées)",
        "editor.options.category_merge.global_local_dynamic_sorted_total"   : "[3] Globales + Locales + Dynamiques (entièrement triées)",
        ...
        "editor.options.inputrow.bottom"                : "En bas",
        
        "editor.labels.entity"                          : "Liste de choses à faire (Entité)",
        "editor.labels.highlight_words"                 : "Mots mis en évidence",
        "editor.labels.chips_with_cat_color"            : "Utiliser les couleurs de catégories",
        "editor.labels.highlight_color"                 : "Couleur de mise en évidence",
        "editor.labels.chip_merge"                      : "Combiner les chips",
        "editor.labels.local_chips"                     : "Autoriser les chips locaux ?",
        "editor.labels.chip_font_size"                  : "Taille de police des chips (px)",
        "editor.labels.chip_color"                      : "Couleur des chips locaux (navigateur)",
        "editor.labels.chip_color_global"               : "Couleur des chips globaux (fichier texte)",
        "editor.labels.chip_color_default"              : "Couleur des chips standards",
        "editor.labels.chip_color_dish"                 : "Couleur des chips de plats",
        "editor.labels.list_font_size"                  : "Taille de police de la liste (px)",
        "editor.labels.title_font_size"                 : "Taille de police du titre (px)",
        "editor.labels.cat_font_size"                   : "Taille de police des catégories (px)",
        "editor.labels.chips_width"                     : "Largeur des chips - « (Auto) Panel Mode » uniquement",
        "editor.labels.chips_position"                  : "Position des chips",
        "editor.labels.quantity"                        : "Position de la quantité de l'article",
        "editor.labels.acknowledged"                    : "Articles terminés",
        "editor.labels.chip_click"                      : "Comportement au clic sur un chip",
        "editor.labels.show_quantity_box"               : "Afficher le champ de quantité",
        "editor.labels.show_submit_button"              : "Afficher le bouton d'ajout",
        "editor.labels.show_qrscan_button"              : "Afficher le bouton Scanner QR (uniquement en https)",
        ...
        "editor.labels.external_url"                    : "URL (externe) de Home Assistant (pour l'accès via l'exportation)",
        "editor.labels.bubble_card"                     : "Mode Bubble PopUp Card",
        "editor.labels.chip_file"                       : "Chemin vers le fichier texte des chips globaux",
        "editor.labels.ean_file"                        : "Chemin vers le fichier texte de la liste EAN locale",
        "editor.labels.category_file"                   : "Chemin vers le fichier texte des catégories globales",
        "editor.labels.title"                           : "Titre",
        "editor.labels.title_icon"                      : "Icône du titre",
        "editor.labels.todo_yellow_m"                   : "Seuil d'alerte pour les intervalles en mois",
        "editor.labels.todo_yellow_d"                   : "Seuil d'alerte pour les intervalles en jours",
        "editor.labels.todo_yellow_h"                   : "Seuil d'alerte pour les intervalles en heures",
        "editor.labels.todo_yellow_s"                   : "Seuil d'alerte pour les échéances sans heure",
        "editor.labels.todo_warning_thresholds"         : "Seuils d'alerte pour le mode liste de choses à faire",
        "editor.labels.show_title_info"                 : "Afficher la prochaine échéance en mode liste de choses à faire",
        "editor.labels.show_title_info_icon"            : "Afficher l'icône pour la prochaine échéance",
        ...
        "editor.helpers.todo_warning_thresholds"        : "Configuration des seuils d'avertissement en mode liste de choses à faire. Les valeurs sont spécifiées en minutes et déterminent quand les tâches sont marquées comme « bientôt à échéance ».",
        "editor.helpers.todo_yellow_m"                  : "Seuil d'alerte pour les intervalles en mois, défini en minutes (Défaut : 1440 = 24 heures)",
        "editor.helpers.todo_yellow_d"                  : "Seuil d'alerte pour les intervalles en jours, défini en minutes (Défaut : 120 = 2 heures)",
        "editor.helpers.todo_yellow_h"                  : "Seuil d'alerte pour les intervalles en heures, défini en minutes (Défaut : 10)",
        "editor.helpers.todo_yellow_s"                  : "Seuil d'alerte pour les échéances sans heure précise, défini en minutes (Défaut : 120 = 2 heures)",
        "editor.helpers.title"                          : "Le titre de la carte. Laissez vide pour le masquer",
        ...
        "editor.helpers.notify_entity_smtp"             : "Nom de la plateforme SMTP notify (depuis configuration.yaml) utilisée pour l'envoi d'e-mails HTML. Important : il s'agit uniquement du nom défini via « name: monNom », ex. « email_notification », et non de l'entité complète comme « notify.email_notification ».",
        ...
        "editor.helpers.highlight_color"                : "Code couleur hexadécimal ou rgba pour les mots mis en évidence. Ex : « #D9534F », « rgba(255,0,0,0.5) », « red ».",
        "editor.helpers.chip_merge"                     : "Détermine comment les chips globaux, standards et du navigateur sont combinés et affichés.",
        "editor.helpers.list_font_size"                 : "Taille de police pour les articles de la liste. Par défaut : 14px.",
        "editor.helpers.title_font_size"                : "Taille de police du titre. Par défaut : 16px.",
        "editor.helpers.cat_font_size"                  : "Taille de police pour les catégories de la liste. Par défaut : 16px.",
        "editor.helpers.chip_font_size"                 : "Taille de police pour les chips de sélection rapide. Par défaut : 12px.",
        "editor.helpers.chip_color"                     : "Code couleur hexadécimal ou rgba pour les chips locaux (navigateur), ex. « #2196f3 » ou « rgba(100,100,100,0.3) ».",
        "editor.helpers.chip_color_global"              : "Code couleur hexadécimal ou rgba pour les chips globaux (fichier texte), ex. « #2196f3 » ou « rgba(100,100,100,0.3) ».",
        "editor.helpers.chip_color_default"             : "Code couleur hexadécimal ou rgba pour les chips standards, ex. « #2196f3 » ou « rgba(100,100,255,0.3) ».",
        "editor.helpers.chip_color_dish"                : "Code couleur hexadécimal ou rgba pour les chips de plats, ex. « #745E3D » ou « rgba(100,100,255,0.3) ».",
        "editor.helpers.local_chips"                    : "Les chips locaux sont stockés uniquement dans le navigateur et ne sont pas synchronisés sur vos autres appareils. Ils seront perdus si le cache est vidé.",
        ...
        "editor.helpers.show_quantity_box"              : "Affiche ou masque le petit champ de saisie de quantité (en haut à gauche).",
        "editor.helpers.show_submit_button"             : "Affiche le bouton Ajouter. S'il est masqué, appuyez sur Entrée pour ajouter un article.",
        "editor.helpers.show_qrscan_button"             : "Affiche le bouton de scan QR. Permet de scanner un ou plusieurs articles en même temps via un QR code. Pour plusieurs articles, chacun doit être sur une ligne séparée. Les quantités peuvent être spécifiées entre parenthèses, ex. « Bananes (6) ». Nécessite un accès HTTPS à Home Assistant.",
        "editor.helpers.show_export_button_pdf"         : "Affiche le bouton d'exportation PDF en bas. Permet de télécharger la liste actuelle sous forme de fichier PDF pour un usage hors ligne.",
        "editor.helpers.show_export_button"             : "Affiche le bouton d'exportation HTML en bas. Permet de télécharger la liste actuelle sous forme de fichier HTML pour un usage hors ligne.",
        ...
        "editor.helpers.ean_file"                       : "Exemple : /local/ean.txt, si le fichier se trouve dans le dossier www. Chaque ligne doit contenir une entrée au format « EAN Nom », ex. « 1234567890123 Article Test ». Supporte les formats EAN-8, UPC (12), EAN-13 et GS1-14.",
        ...
        "editor.helpers.category_merge_mode"            : "Choisissez comment les catégories locales, globales et dynamiques doivent être fusionnées. « local_only » n'affiche que les locales, « global_only » que les globales, et « dynamic_only » que les dynamiques. Les autres options combinent deux ou trois types de différentes manières. La priorité de fusion suit l'ordre de lecture de gauche à droite.",
        ...
        "editor.helpers.show_cat_next_due"              : "Si cette option est activée, la prochaine date d'échéance sera affichée sous le nom de la catégorie (en mode liste de choses à faire). Vous pouvez ainsi voir en un coup d'œil quand le prochain article de cette catégorie arrive à échéance.",
        ...
        "editor.helpers.show_cat_count"                 : "Si cette option est activée, le nombre d'articles de chaque catégorie sera affiché à côté de son nom. En mode liste de choses à faire, le décompte s'affiche de manière inversée : le nombre avant le « / » n'inclut que les entrées qui ne sont pas encore à échéance. (Exemple : 3/5 signifie que sur 5 entrées, 3 ne sont pas encore arrivées à échéance.) Ainsi, un (5/5) indique clairement qu'il n'y a actuellement aucune tâche urgente.",
        ...
        "editor.helpers.longlived_token"                : "Un jeton d'accès de longue durée pour l'authentification avec Home Assistant. Il peut être créé dans le profil utilisateur sous Sécurité → Jetons d'accès de longue durée. Attention : gardez ce jeton confidentiel car il accorde un accès total à votre système. Notez également qu'en HTTP, le jeton est transmis en clair et donc non sécurisé.",
        "editor.helpers.external_url"                   : "L'URL (externe) de votre installation Home Assistant (ex. 'https://mon-ha.duckdns.org:8123'). Requise si vous utilisez l'exportation pour synchroniser les articles plus tard avec Home Assistant. Si vide, l'URL depuis laquelle le tableau de bord a été accédé lors de l'exportation sera utilisée.",
        "editor.helpers.categories"                     : "Les catégories vous permettent de regrouper automatiquement les articles. Chaque catégorie commence par - name: <NomCatégorie> et contient une liste de mots-clés sous « items ». Exemple : - name: Fruits items: - Fraises - Prunes - Poires - Bananes. En option, vous pouvez ajouter une icône (ex. mdi:apple) et une couleur de fond (bgcolor, ex. #247645). Tout article correspondant à un mot-clé sera automatiquement attribué. Lors de la création d'une carte, un modèle par défaut est ajouté en exemple.",
        "editor.helpers.dishes"                         : "Avec les plats, vous pouvez ajouter plusieurs articles en une seule fois. Chaque plat commence par - name: <Plat> et contient une liste d'articles sous « items ». Exemple : - name: McDonalds items: - Cheeseburger - BigMac (2) - Frites - Hamburger (4). Chaque plat peut en option avoir une couleur de fond (bgcolor, ex. #247645). Pour plus d'informations sur la structure, veuillez consulter la documentation."
    }
};
